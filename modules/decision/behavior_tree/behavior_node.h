...
//    std::cout<<name_<<" "<<__FUNCTION__<<behavior_state_<<std::endl;
...
class PreconditionNode: public DecoratorNode{
 ...
 protected:
  ...
  virtual void OnInitialize() { std::cout<<name_<<" "<<__FUNCTION__<<std::endl; };
...
class SelectorNode: public CompositeNode{
 ...
 protected:
  virtual void OnInitialize(){
    children_node_index_ = 0;std::cout<<name_<<" "<<__FUNCTION__<<std::endl;
  };
  virtual BehaviorState Update(){
